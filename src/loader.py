...
def extract_metadata(doc_content):
    ...
    try:
        # Lists of weekdays to search for
        ...
        # Check if any day of the week is present in the line. 
        days_found = []
        first_day = True
        ...
        # Checks if any week is present in the line
        weeks_found = []
        for week in weeks:
...
def transform_text(text):
    # Transform the text to lowercase and remove punctuation
    text_array = []
    for t in text:
        t = (str(t)).lower()
